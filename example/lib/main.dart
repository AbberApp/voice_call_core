...
Future<void> initializeVoiceCallCore() async {
  try {
    ...
    debugPrint('✅ Voice Call Core initialized successfully');
  } catch (e) {
    debugPrint('❌ Failed to initialize Voice Call Core: $e');
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _initializeManagers() {
    if (VoiceCallCore.isInitialized) {
      ...
      setState(() {
        _status = 'Recording manager initialized';
      });
    } else {
      setState(() {
